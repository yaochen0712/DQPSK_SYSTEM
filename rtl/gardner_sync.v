module gardner_sync#(
    ...
    parameter DECISION_THRESHOLD = 10
)
(
    ...
    output wire [15:0]  o_dbg_wn    ,  // Gardner环路滤波器输出（收敛状态）
    output wire         o_dbg_strobe   // NCO溢出/有效插值时刻
);
    ...
    assign o_dbg_wn     = wn;
    assign o_dbg_strobe = strobe_flag;
